                ...
                <section className="footer-bottom">
                    <div className="footer-bottom-container">
                        <div className="footer-copyright">
                            ...
                            <a href=""><img src={require('../assets/img/footer-logo.png').default} alt="" /></a>
                        </div>
                        <div className="footer-cart">
                            <a href=""><img src={require('../assets/img/visa.png').default} alt="" /></a>
                            <a href=""><img src={require('../assets/img/master-card.png').default} alt="" /></a>
                        </div>
                    </div>
                </section>
            </div>
